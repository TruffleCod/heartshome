            ...
            <div>
              ...
              <div style={{ display: 'grid', gridTemplateColumns: 'repeat(7, 1fr)', gap: 8, marginBottom: 8 }}>
                {WEEK_HEADERS.map((item) => (
                  <div key={item} style={{ textAlign: 'center', color: '#6f837a', fontSize: 13 }}>
                    {item}
                  </div>
                ))}
              </div>
              ...
              <div style={{ display: 'grid', gridTemplateColumns: 'repeat(7, 1fr)', gap: 8 }}>
                {cells.map((day, index) => {
                  if (!day) {
                    return <div key={`empty-${index}`} style={{ minHeight: 62, background: '#f6f8f7', borderRadius: 8 }} />;
                  }
                  ...
                  return (
                    <button
                      ...
                      style={{
                        minHeight: 62,
                        borderRadius: 8,
                        border: active ? '1px solid #2f7a4a' : '1px solid #e0e9e4',
                        background: active ? '#1f3f2d' : '#fff',
                        color: active ? '#fff' : canBook ? '#2e463d' : '#b3c2ba',
                    ...
                    return (
                      <button
                        ...
                        style={{
                          ...
                          background: active ? '#2f7a4a' : '#58b778',
                          color: '#fff',
                          borderRadius: 8,
                          fontSize: 18,
                          fontWeight: 700,
