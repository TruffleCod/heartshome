...
const storyPoints = [
  ...
  <>
    一年前，妹妹中考超常发挥，考入了你们城市最有名的重点高中，从那时开始，原本开朗的妹妹逐渐变得沉默寡言，原本你们以为她只是课业压力大，直到有一天，她开始无法起床上学，你们才意识到事态的严重。在医院检查后，妹妹被确诊为抑郁症。
  </>,
  <>
...
const playPoints = [
  <>
    ...
    当前暂时只支持电脑端打开，建议你准备一个笔记本或者是电子文档，及时记录看起来有用的信息。真相或许就藏在不起眼的细节当中。
  </>,
  <>
    <strong>本游戏的所有的交互是基于现实常识设计的，只有【鼠标点击】和【键盘输入】两种。</strong>
  </>,
  <>
    如果你不知道从何开始，这里有一个小小的提示： <strong>尝试登陆妹妹的账号。</strong>无法继续推进的时候，仔细阅读文本中的线索，或点击一切看起来能被点击的地方。
  </>,
  <>
    <strong>部分谜题运用到的知识，可能需要使用到搜索引擎进行查询。</strong>
    只要你找对了关键词，通常可以很快地发现你要找的答案。当然，在现在这个时代你也可以直接询问AI，他们检索信息的能力或许更强大。
  </>,
  <>
