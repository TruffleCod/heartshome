...
const storyPoints = [
  ...
  <>
    更让你不安的是，这已经不是最近第一起类似事件。过去几个月里，本市陆续出现过几起少女失踪事件。新闻报道说失踪者多为十几岁的在校女生，失踪前都曾表现出情绪异常，警方尚未公布案件之间是否存在关联。
  </>,
  <>
...
const playPoints = [
  <>
    ...
    建议你准备一个笔记本，或者是电子文档，及时记录看起来有用的信息。真相或许就藏在不起眼的细节当中。
  </>,
  <>
  ...
  <>
    本游戏含有少量恐怖元素。部分灵感来源于oobmab老师的《黑太岁》《巴啵的牧群》等中式克苏鲁作品，但是文笔和设定远不及其项背。在此也趁机推荐一下这两部佳作。
  </>,
];
    ...
    <div className="start-game-page">
      <main className="start-game-shell">
        <section className="start-game-hero">
          <div>
            <p className="start-game-kicker">心之家 / 网页推理游戏</p>
            <h1>开始之前</h1>
          </div>
          <p>
            阅读以下故事背景与玩法说明后，再进入网站。这个页面不会提供站内导航；当你点击“开始游戏”后，才会正式进入心之家。
          </p>
        </section>
