...
const pageRoutes = [
  ...
  { path: '/p/91b7c2e0a4', component: PostDetail, pageNumber: '11', props: { postId: 'career-empty' } },
  { path: '/p/6e58c2b9a1', component: Login, pageNumber: '05' },
  { path: '/p/fa02d7c8e3', component: RecoverPassword, pageNumber: '06' },
  { path: '/p/1b9c60e4fa', component: Workspace, pageNumber: '12' },
  { path: '/p/e47a92c0d1', component: CounselingRecords, pageNumber: '13', props: { recordCode: 'GDSYC-0428-CJ' } },
  { path: '/p/0f6b83d2a7', component: CounselingRecords, pageNumber: '14', props: { recordCode: 'GDSYC-0514-LXY' } },
  { path: '/p/c5a18f0e9d', component: CounselingRecords, pageNumber: '15', props: { recordCode: 'HJ338-0528-YD001' } },
