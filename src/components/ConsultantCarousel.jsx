...
import yuanZhixia from '../assets/consultants/yuan-zhixia.png';
import luXinyin from '../assets/consultants/lu-xinyin.png';
import chenJi from '../assets/consultants/chen-ji.png';
...
在心之家中，顾正清主要负责平台风险评估模型、咨询师督导、危机处理规范及青少年个案分级流程。他希望心之家能够成为学校、家庭与专业服务之间的补充通道。`,
  },
  {
    title: '袁知夏 · 签约咨询师',
    avatar: yuanZhixia,
...
陈霁重视来访者对身体信号、情绪波动和思维模式的觉察。他擅长通过呼吸练习、身体扫描、正念行走、睡眠放松训练等方式，帮助来访者从持续紧绷和反复思考中暂时抽离，重新回到当下经验，学习以更温和、不评判的方式理解自己的状态。`,
  },
];
