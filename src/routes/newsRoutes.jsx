...
const routes = [
  { path: '/p/44d2ae09f6', component: NewsMissingGirlSearch, pageNumber: '24', progressTheme: 'news', site: 'mingchuanNews' },
  { path: '/p/9fe021c7ad', component: NewsMingchuanThirdMiddleMissingGirls, pageNumber: '25', progressTheme: 'news', site: 'mingchuanNews' },
  { path: '/p/50a8f6c3d1', component: NewsChenJiAward, pageNumber: '26', progressTheme: 'news', site: 'mingchuanNews' },
  { path: '/p/3cf0b79a12', component: NewsMingchuanUniversityArchives, pageNumber: '27', progressTheme: 'news', site: 'mingchuanNews' },
  { path: '/p/2ad87e50c9', component: NewsAbandonedBuildingCollapse, pageNumber: '28', progressTheme: 'news', site: 'mingchuanNews' },
  ...
  { path: '/p/86f1c4b0ed', component: NewsHeartHomeFiveYears, pageNumber: '04', progressTheme: 'news', site: 'mingchuanNews' },
  { path: '/p/ab6f90d2c4', component: NewsWangJingYoungWriter, pageNumber: '41', progressTheme: 'news', site: 'mingchuanNews' },
  { path: '/p/d4c1e8a07f', component: NewsLiuXinyiBubbleHall, pageNumber: '42', progressTheme: 'news', site: 'mingchuanNews' },
];
